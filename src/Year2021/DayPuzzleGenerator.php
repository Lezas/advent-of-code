...
class DayPuzzleGenerator
{
    public static function generateDay(int $day, bool $force = false)
    {
        $dayDir = 'Day' . $day;
        $dayFullDir = __DIR__ . DIRECTORY_SEPARATOR . $dayDir;
    ...
    public static function populateInputFile(int $day, string $content): void
    {
        $dayDir = 'Day' . $day;
        $inputFile = __DIR__ . DIRECTORY_SEPARATOR . $dayDir . DIRECTORY_SEPARATOR . 'input.txt';
    ...
    private static function copyTemplatesToDirectory(int $day, string $dir)
    {
        $namespace = __NAMESPACE__ . '\\Day' . $day;
        $templateDirectory = __DIR__ . DIRECTORY_SEPARATOR . 'Template';
